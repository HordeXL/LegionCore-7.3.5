...
//todo: ðåàëèçîâàòü reroure power, low health, êîððåêòíûé double attack
enum ScriptTexts
{
    //chimaeron
    SAY_AGGRO                       = 0,
...
#define GOSSIP_OPTION_1_RU "ß ïîëàãàþ, òåáå íóæåí êëþ÷ îò ýòîé êëåòêè? Ïîãîäè, íè÷åãî íå ãîâîðè. Íåâåðîÿòíî óæàñíûé ìîíñòð ïîçàäè ìåíÿ ñúåë åãî, íå òàê ëè?"
#define GOSSIP_MENU_2 16593
#define GOSSIP_OPTION_2 "You were trapped, as I recall. This situation seems oddly similar."
#define GOSSIP_OPTION_2_RU "Òû îêàçàëñÿ â ëîâóøêå, êàê ÿ ïîíèìàþ. Ýòà ñèòóàöèÿ êàæåòñÿ ïîäîçðèòåëüíî ïîõîæåé."
#define GOSSIP_MENU_3 16594
#define GOSSIP_OPTION_3 "Gnomes in Lava Suits, for example."
#define GOSSIP_OPTION_3_RU "Ãíîìà â ëàâà-êîñòþìå, íàïðèìåð."
#define GOSSIP_MENU_4 16595
#define GOSSIP_OPTION_4 "No, I, uh, haven't seen it. You were saying?"
#define GOSSIP_OPTION_4_RU "Íåò, ÿ, ý-ý, íå âèäåë åãî. Òàê ÷òî òû ãîâîðèë?"
#define GOSSIP_MENU_5 16596
#define GOSSIP_OPTION_5 "Restrictions? What restrictions?"
#define GOSSIP_OPTION_5_RU "Óñëîâèÿ? ×òî çà óñëîâèÿ?"
