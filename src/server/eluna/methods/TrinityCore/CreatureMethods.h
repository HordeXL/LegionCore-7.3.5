...
namespace LuaCreature
{
     ...
     */
    int IsRegeneratingHealth(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int SetRegeneratingHealth(Eluna* /*E*/)
{
    return 1;
}
    ...
    int CanCompleteQuest(Eluna* /*E*/)
{
     ...
     */
    int IsTargetableForAttack(Eluna* /*E*/)
{
    return 1;
}
    ...
    int CanAssistTo(Eluna* /*E*/)
{
     ...
     */
    int HasSearchedAssistance(Eluna* /*E*/)
{
    return 1;
}
    ...
    int IsWorldBoss(Eluna* /*E*/)
{
     ...
     */
    int HasCategoryCooldown(Eluna* /*E*/)
{
    return 1;
}
    ...
    int IsTrigger(Eluna* /*E*/)
{
     ...
     */
    int IsDamageEnoughForLootingAndReward(Eluna* /*E*/)
{
    return 1;
}
#endif
    ...
    int GetWaypointPath(Eluna* /*E*/)
{
     ...
     * @return uint32 wpId
     */
    int GetCurrentWaypointId(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int GetDefaultMovementType(Eluna* /*E*/)
{
    return 1;
}
    ...
    int GetAttackDistance(Eluna* /*E*/)
{
     ...
     */
    int GetLootRecipientGroup(Eluna* /*E*/)
{
    return 1;
}
    ...
    int GetScriptId(Eluna* /*E*/)
{
     ...
     */
    int GetCreatureSpellCooldownDelay(Eluna* /*E*/)
{
    return 1;
}
    ...
    int SetAggroEnabled(Eluna* /*E*/)
{
     ...
     */
    int SetDisableReputationGain(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int SetInCombatWithZone(Eluna* /*E*/)
{
    return 1;
}
    ...
    int SetRespawnDelay(Eluna* /*E*/)
{
     ...
     */
    int SetDefaultMovementType(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int SetNoSearchAssistance(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int SetNoCallAssistance(Eluna* /*E*/)
{
    return 1;
}
    ...
    int CallForHelp(Eluna* /*E*/)
{
     ...
     */
    int FleeToGetAssistance(Eluna* /*E*/)
{
    return 1;
}
