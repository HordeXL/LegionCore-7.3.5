    ...
    int GetName(Eluna* /*E*/)
{
     ...
     * @return uint32 count
     */
    int GetAlivePlayersCountByTeam(Eluna* /*E*/)
{
    return 1;
}
    ...
    int GetMap(Eluna* /*E*/)
{
     ...
     */
    int GetBonusHonorFromKillCount(Eluna* /*E*/)
{
    return 1;
}
    ...
    int GetEndTime(Eluna* /*E*/)
{
     ...
     */
    int GetFreeSlotsForTeam(Eluna* /*E*/)
{
    return 1;
}
    ...
    int GetMinPlayers(Eluna* /*E*/)
{
     ...
     */
    int GetMaxPlayersPerTeam(Eluna* /*E*/)
{
    return 1;
}
     ...
     */
    int GetMinPlayersPerTeam(Eluna* /*E*/)
{
    return 1;
}
