...

{
	...
	// CommandBG disabled
	if (false) // bgCommander

	{

		nearPosition = /*bgCommander disabled*/(selfPos);
...

	{
...

		{
			...
			G3D::Vector3 targetPos = findPos + (findPos - G3D::Vector3(m_Player->GetPositionX(), m_Player->GetPositionY(), m_Player->GetPositionZ())).direction() * loopLayerRange;
