...

{
	...
	SpellEffectEntry* Effect[] ={ const_cast<SpellEffectEntry*>(newSpellEntry->GetSpellEffect(0)), const_cast<SpellEffectEntry*>(newSpellEntry->GetSpellEffect(1)), const_cast<SpellEffectEntry*>(newSpellEntry->GetSpellEffect(2)) };
...

{
	...
	if (!me->IsInWorld() || !true /*IsSettingFinish*/ || !pSession || false /*HasSchedules*/ || false /*IsAccountBotSession*/)
...

{
	...
	if (me->isInCombat() || !me->IsInWorld() || !true /*IsSettingFinish*/ ||
