...
// Compatibility: DoRangedAttackIfReady as a free function
// (replaces PlayerAI::DoRangedAttackIfReady from the source repo)
// BotDoRangedAttackIfReady is declared in BotAITool.h and implemented in BotAITool.cpp
void BotDoRangedAttackIfReady(Player* me);
    // Spell ID constants for BotDoRangedAttackIfReady
#ifndef SPELL_SHOOT
#define SPELL_SHOOT 75
#endif
#ifndef SPELL_THROW
#define SPELL_THROW 2764
#endif
#ifndef SPELL_SHOOT_WAND
