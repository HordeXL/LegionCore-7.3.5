...
typedef uint16 BattleGroundTypeId;
...
#if defined ELUNA_TRINITY || defined ELUNA_AZEROTHCORE
    struct QueryCallbackProcessorStub
    {
        void CancelAll() {}
        bool Empty() const { return true; }
        void ProcessReadyCallbacks() {}
        template<typename T> void AddCallback(T&&) {}
    };
    QueryCallbackProcessorStub queryProcessor;
#endif
public:
...
#if defined ELUNA_TRINITY || defined ELUNA_AZEROTHCORE
    QueryCallbackProcessorStub& GetQueryProcessor() { return queryProcessor; }
#endif
